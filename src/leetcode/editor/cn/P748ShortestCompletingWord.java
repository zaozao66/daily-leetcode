...
// words[i] 由小写英文字母组成 
// 
// Related Topics 数组 哈希表 字符串 👍 62 👎 0
...
class Solution {
    public String shortestCompletingWord(String licensePlate, String[] words) {
        ...
        getArray(plate, licensePlate);
        for (int i = 0; i < words.length; i++) {
            getArray(wordArr, words[i]);
            if (isOk(plate, wordArr)) {
    ...
    public boolean isOk(int[] arr1, int[] arr2) {
    ...
    public void getArray(int[] arr, String word) {
        Arrays.fill(arr, 0);
